...
declare class Consola {
    ...
    restoreConsole(): void;
    wrapStd(): void;
    _wrapStream(stream: NodeJS.WriteStream | undefined, type: string): void;
    restoreStd(): void;
...
type ConsolaInstance = Consola & Record<LogType, (message: InputLogObject | any, ...args: any[]) => void>;

export { ConsolaOptions as C, FormatOptions as F, InputLogObject as I, LogLevels as L, ConsolaInstance as a, LogTypes as b, Consola as c, LogLevel as d, LogType as e, LogObject as f, ConsolaReporter as g };
